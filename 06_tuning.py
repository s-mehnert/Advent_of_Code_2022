...
print(f"The start-of-packet marker is found after processing {pos_start_of_packet_marker} characters in the datastream.")
...
print(f"The start-of-message marker is found after processing {pos_start_of_message_marker} characters in the datastream.")
